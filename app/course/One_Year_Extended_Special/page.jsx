...
import littlegine from "@/assets/course/11.png";
...
export const metadata = {
  title: "FIITJEE Bokaro || Class 12(Pass) Offline Course",
        ...
        <div className="course ">
          <div className="">
            <div className="flex gap-3 p-2 flex-wrap sm:gap-0">
              <Link href="/">Home </Link>
              <span> / </span>
              <Link href="/course"> Class 12(Pass) Offline Course </Link>
              <span> / </span>
              <Link href="/course/One_Year_Extended"> One_Year_Extended</Link>
            </div>
            <div className="flex flex-col justify-between  p-2">
              <h1 className="text-5xl font-bold sm:text-3xl ml-10 sm:ml-0 mt-5 sm:mt-0">
                One Year Extended Classroom Program
              </h1>
              <div className="flex sm:flex-wrap">
                <div className=" w-[60%] sm:w-[100%]">
                  <p className="ml-10 sm:ml-0  mt-5   ">
                    Our one-year extended classroom program is specifically
                    designed for students who have appeared or passed their XII
                    exams and are aiming to excel in the JEE (Advanced) 2024.
                    This comprehensive program provides focused and intensive
                    preparation to enhance students' conceptual understanding,
                    problem-solving skills, and exam performance. With a highly
                    experienced faculty, a well-structured curriculum, and
                    regular assessments, our program ensures that students
                    receive personalized attention and guidance.
                    <span className="sm:hidden">
                      {" "}
                      By joining our program, students will benefit from a
                      supportive learning environment that nurtures their
                      potential and equips them with the necessary knowledge and
                      strategies to achieve exceptional results in the JEE
                      (Advanced) 2024 examination.
                    </span>
                  </p>
                  <div className="flex flex-wrap gap-5">
                    ...
                    <div className="flex ml-10 sm:ml-0  items-center sm:gap-3 gap-5 mt-3">
                      <Image
                        ...
                        className="h-[2rem] w-[2rem]"
                      />{" "}
                      <span className="flex justify-center">547 hrs </span>
                    </div>
                  </div>
                  <div className="flex ml-10 sm:ml-0  items-center gap-5 sm:gap-3 mt-3">
                    <Image
                ...
                <div className=" w-[30%] ml-10 sm:ml-0 sm:mt-10 rounded-lg bg-primary-light  bg-opacity-40 sm:opacity-100  shadow-2xl text-primary sm:w-[100%] p-4 sm:p-2">
                  ...
                  <ul>
                    ...
                    <li className="mt-2 flex gap-5">
                      ...
                      />
                      <span className="font-bold">
                        547 + hours of classroom teaching.
                      </span>
                    </li>
                    <li className="mt-2 flex gap-5">
                      {" "}
