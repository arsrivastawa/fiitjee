...
import littlegine from "@/assets/course/12.png";
        ...
        <div className="course ">
          <div className="">
            <div className="flex gap-3 p-2 flex-wrap sm:gap-0">
              ...
              <span> / </span>
              <Link href="/course/Special">Special</Link>
            </div>
            <div className="flex flex-col justify-between  p-2">
              <h1 className="text-5xl font-bold sm:text-3xl ml-10 sm:ml-0 mt-5 sm:mt-0">
                One Year Special Classroom Program
              </h1>
              <div className="flex sm:flex-wrap">
                <div className=" w-[60%] sm:w-[100%]">
                  <p className="ml-10 sm:ml-0  mt-5   ">
                    Our one-year extended classroom program for JEE (Advanced)
                    2024 is tailored specifically for students who have appeared
                    or passed their XII exams. This comprehensive program is
                    meticulously designed to provide focused and rigorous
                    preparation, enabling students to enhance their conceptual
                    understanding and problem-solving skills. With a highly
                    experienced faculty, a well-structured curriculum, and
                    regular assessments, .
                    <span className="sm:hidden">
                      {" "}
                      our program ensures that students receive personalized
                      attention and guidance throughout their journey. By
                      enrolling in this program, students will benefit from a
                      supportive learning environment that fosters their
                      potential and equips them with the necessary knowledge and
                      strategies to excel in the JEE (Advanced) 2024 examination
                    </span>
                  </p>
