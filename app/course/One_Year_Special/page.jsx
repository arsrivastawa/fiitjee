...
import littlegine from "@/assets/course/10.png";
...
export const metadata = {
  title: "FIITJEE Bokaro || Class 12 Offline Course",
        ...
        <div className="course ">
          <div className="">
            <div className="flex gap-3 p-2 flex-wrap sm:gap-0">
              <Link href="/">Home </Link>
              <span> / </span>
              <Link href="/course"> Class 12 Offline Course </Link>
              <span> / </span>
              <Link href="/course/One_Year_Special"> One_Year_Special</Link>
            </div>
            <div className="flex flex-col justify-between  p-2">
              <h1 className="text-5xl font-bold sm:text-3xl ml-10 sm:ml-0 mt-5 sm:mt-0">
                Special 1 Year Classroom Program
              </h1>
              <div className="flex sm:flex-wrap">
                <div className=" w-[60%] sm:w-[100%]">
                  <p className="ml-10 sm:ml-0  mt-5   ">
                    Our synchronized study program is designed to provide
                    comprehensive preparation for XII Boards, JEE (Advanced),
                    JEE (Main), and other competitive entrance exams. Through
                    this program, students gain a well-rounded understanding of
                    the subjects covered in XII Boards, along with specialized
                    training to excel in JEE (Advanced) and JEE (Main).
                    Additionally, the program caters to the requirements of
                    various other competitive entrance exams, equipping students
                    with the knowledge, skills, and strategies needed to
                    succeed.
                    <span className="sm:hidden">
                      {" "}
                      With experienced faculty, structured curriculum, and
                      regular assessments, our program ensures that students
                      receive personalized attention and guidance to maximize
                      their potential and achieve outstanding results in their
                      chosen exams.
                    </span>
                  </p>
                  <div className="flex flex-wrap gap-5">
                    ...
                    <div className="flex ml-10 sm:ml-0  items-center sm:gap-3 gap-5 mt-3">
                      <Image
                        ...
                        className="h-[2rem] w-[2rem]"
                      />{" "}
                      <span className="flex justify-center">474 hrs </span>
                    </div>
                  </div>
                  <div className="flex ml-10 sm:ml-0  items-center gap-5 sm:gap-3 mt-3">
                    <Image
                  ...
                  <ul>
                    <li className="mt-2 flex gap-5">
                      ...
                      <span className="font-bold">
                        Merge program for JEE (Advanced) students.
                      </span>
                    </li>
                    <li className="mt-2 flex gap-5">
                      {" "}
                      ...
                      />
                      <span className="font-bold">
                        474 + hours of classroom teaching.
                      </span>
                    </li>
                    <li className="mt-2 flex gap-5">
                      {" "}
          ...
          <ul className="p-4 flex sm:flex-wrap flex-col w-[60%] sm:w-[100%] overflow-auto gap-5">
            <li className="mt-2 flex gap-5 items-center bg-primary-light shadow-lg rounded-lg p-4">
              <p className="flex gap-5 font-bold">
                ...
                />
                Excellence in JEE : Emphasis on making the students imbibe the
                fundamental concepts of Physics, Chemistry & Mathematics and on
                sharpening their analytical skills and parallel thinking process
                which makes them capable of creatively resolving complex and
                tricky problems by mere application of basic concepts for a
                quantum jump in their performance in JEE Main & Advanced. Each
                student has the right strategy for himself/herself for TIME
                MANAGEMENT to ensure optimum output. This enables the students
                to excel not only in JEE (Main) but also in JEE (Advanced) &
          ...
          <ul className="p-4 ">
            <li className="mt-2 flex gap-5 items-center bg-primary-light shadow-lg rounded-lg p-4">
              ...
              <div className=" flex gap-5">
                ...
                <p>
                  <span className="font-bold">
                    The Students of this program will be merged with Students of
                    Two Year Classroom Program for JEE (Advanced), 2024 i.e.
                    from Phase IV onwards as per their performance in the
                    Admission Test so as to give them competitive environment.
                  </span>
                </p>
              </div>
            </li>
