...
import littlegine from "@/assets/course/9.png";
        ...
        <div className="course ">
          <div className="">
            <div className="flex gap-3 p-2 flex-wrap sm:gap-0">
              ...
              <span> / </span>
              <Link href="/course/One_Year"> One_Year</Link>
            </div>
              ...
              <div className="flex sm:flex-wrap">
                <div className=" w-[60%] sm:w-[100%]">
                  <p className="ml-10 sm:ml-0  mt-5   ">
                    Our integrated study program offers a comprehensive approach
                    by combining the study of XII Boards, JEE Main & Advanced,
                    International Olympiads, National level scholastic exams,
                    and other engineering entrance examinations. This program is
                    designed to provide students with a holistic education that
                    prepares them for multiple academic challenges. By
                    synchronizing the preparation for these exams, students can
                    optimize their study time and resources while developing a
                    deep understanding of the core subjects.
                    <span className="sm:hidden">
                      {" "}
                      Our program covers a wide range of topics, emphasizes
                      problem-solving skills, and incorporates practice
                      materials and mock exams to familiarize students with the
                      exam formats. With experienced instructors and a
                      structured curriculum, our integrated study program equips
                      students with the necessary knowledge and skills to excel
                      in their XII Boards, JEE Main & Advanced, and other
                  ...
                  <div className="flex flex-wrap gap-5">
                    ...
                    <div className="flex ml-10 sm:ml-0  items-center sm:gap-3 gap-5 mt-3">
                      <Image
                        ...
                        className="h-[2rem] w-[2rem]"
                      />{" "}
                      <span className="flex justify-center">530 hrs </span>
                    </div>
                  </div>
                  <div className="flex ml-10 sm:ml-0  items-center gap-5 sm:gap-3 mt-3">
                    <Image
                ...
                <div className=" w-[30%] ml-10 sm:ml-0 sm:mt-10 rounded-lg bg-primary-light  bg-opacity-40 sm:opacity-100  shadow-2xl text-primary sm:w-[100%] p-4 sm:p-2">
                  ...
                  <ul>
                    ...
                    <li className="mt-2 flex gap-5">
                      ...
                      />
                      <span className="font-bold">
                        530 + hours of classroom teaching.
                      </span>
                    </li>
                    <li className="mt-2 flex gap-5">
                      {" "}
