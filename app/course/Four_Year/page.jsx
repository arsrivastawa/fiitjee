...
import littlegine from "@/assets/course/5.png";
        ...
        <div className="course ">
          <div className="">
            <div className="flex gap-3 p-2 flex-wrap sm:gap-0">
              ...
              <span> / </span>
              <Link href="/course/Four_Year"> Four_Year</Link>
            </div>
              ...
              <div className="flex sm:flex-wrap">
                <div className=" w-[60%] sm:w-[100%]">
                  <p className="ml-10 sm:ml-0  mt-5   ">
                    The synchronized study of X Board, XII Boards, International
                    Olympiads, and National Level Scholastic Exams like the
                    National Talent Search Exam (NTSE) involves a comprehensive
                    and well-planned approach to academic preparation. Students
                    allocate time and effort to cover the X Board and XII Board
                    syllabi, focusing on key concepts and practicing past
                    papers.
                    <span className="sm:hidden">
                      {" "}
                      Additionally, they engage in specialized training for
                      International Olympiads, which includes solving
                      challenging problems and learning advanced concepts. The
                      National Talent Search Exam (NTSE) is also given due
                      importance, with regular practice of reasoning and mental
                      ability exercises. This synchronized study plan requires
                      effective time management, organizational skills, and
                      guidance from teachers and mentors. By adopting this
                      approach, students benefit from a well-rounded education,
                      perform well in multiple exams, and develop critical.
                    </span>
                  </p>
                  <div className="flex flex-wrap gap-5">
                    ...
                    <div className="flex ml-10 sm:ml-0  items-center sm:gap-3 gap-5 mt-3">
                      <Image
                        ...
                        className="h-[2rem] w-[2rem]"
                      />{" "}
                      <span className="flex justify-center">1287 hrs </span>
                    </div>
                  </div>
                  <div className="flex ml-10 sm:ml-0  items-center gap-5 sm:gap-3 mt-3">
                    <Image
                  ...
                  <ul>
                    <li className="mt-2 flex gap-5">
                      ...
                      <span className="font-bold">
                        Thirteen-phase course coverage.
                      </span>
                    </li>
                    <li className="mt-2 flex gap-5">
                      {" "}
                      ...
                      />
                      <span className="font-bold">
                        1287 + hours of classroom teaching.
                      </span>
                    </li>
                    <li className="mt-2 flex gap-5">
                      {" "}
          ...
          <ul className="p-4 ">
            <li className="mt-2 flex gap-5 items-center bg-primary-light shadow-lg rounded-lg p-4">
              ...
              <div className=" flex gap-5">
                ...
                <p>
                  <span className="font-bold">
                    Entire course is divided into 13 phases:
                  </span>
                  4 phases in class IX, 4 phases in Class X, and 3 phases in
                  Class XI & 2 phases in Class XII followed by special classes
                  of Rank Improvement Program
                </p>
              </div>
            </li>
            <li className="mt-2 flex gap-5 items-center bg-primary-light shadow-lg rounded-lg p-4">
