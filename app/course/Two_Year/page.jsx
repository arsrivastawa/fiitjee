...
import littlegine from "@/assets/course/8.png";
...
export const metadata = {
  title: "FIITJEE Bokaro || Class 11 Offline Course",
        ...
        <div className="course ">
          <div className="">
            <div className="flex gap-3 p-2 flex-wrap sm:gap-0">
              <Link href="/">Home </Link>
              <span> / </span>
              <Link href="/course"> Class 11 Offline Course </Link>
              <span> / </span>
              <Link href="/course/Two_Year"> Two_Year</Link>
            </div>
              ...
              <div className="flex sm:flex-wrap">
                <div className=" w-[60%] sm:w-[100%]">
                  <p className="ml-10 sm:ml-0  mt-5   ">
                    Our program has consistently produced a remarkable number of
                    toppers, making it the go-to choice for students aiming to
                    achieve exceptional results. With a proven track record of
                    success, our program provides a comprehensive and rigorous
                    curriculum combined with expert faculty and innovative
                    teaching methodologies. We prioritize personalized attention
                    and mentoring, ensuring that each student receives the
                    guidance and support needed to excel academically.
                    <span className="sm:hidden">
                      {" "}
                      Through rigorous practice sessions, mock tests, and
                      regular assessments, we focus on honing students'
                      problem-solving skills and enhancing their conceptual
                      understanding. With a commitment to excellence, our
                      program continues to empower students to reach the
                      pinnacle of academic success and secure top positions in
                  ...
                  <div className="flex flex-wrap gap-5">
                    ...
                    <div className="flex ml-10 sm:ml-0  items-center sm:gap-3 gap-5 mt-3">
                      <Image
                        ...
                        className="h-[2rem] w-[2rem]"
                      />{" "}
                      <span className="flex justify-center">728 hrs </span>
                    </div>
                  </div>
                  <div className="flex ml-10 sm:ml-0  items-center gap-5 sm:gap-3 mt-3">
                    <Image
                ...
                <div className=" w-[30%] ml-10 sm:ml-0 sm:mt-10 rounded-lg bg-primary-light  bg-opacity-40 sm:opacity-100  shadow-2xl text-primary sm:w-[100%] p-4 sm:p-2">
                  ...
                  <ul>
                    ...
                    <li className="mt-2 flex gap-5">
                      ...
                      />
                      <span className="font-bold">
                        728 + hours of classroom teaching.
                      </span>
                    </li>
                    <li className="mt-2 flex gap-5">
                      {" "}
          ...
          <ul className="p-4 ">
            <li className="mt-2 flex gap-5 items-center bg-primary-light shadow-lg rounded-lg p-4">
              ...
              <div className=" flex gap-5">
                ...
                <p>
                  <span className="font-bold">
                    Entire course is divided into 5 phases
                  </span>
                  (Class XI – 3 Phases & Class XII – 2 Phases) followed by
                  special classes of Rank Improvement Program.
                </p>
              </div>
            </li>
            <li className="mt-2 flex gap-5 items-center bg-primary-light shadow-lg rounded-lg p-4">
